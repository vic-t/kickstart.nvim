...
require('lazy').setup({
  ...
  { -- Highlight, edit, and navigate code
    ...
    opts = {
      ensure_installed = { 'bash', 'sql', 'c', 'diff', 'html', 'lua', 'luadoc', 'markdown', 'markdown_inline', 'query', 'vim', 'vimdoc', 'yaml' },
      ...
      textobjects = {
        ...
        move = {
          enable = true,
          set_jumps = true,
          goto_next_start = { [']S'] = '@statement.outer' },
          goto_previous_start = { ['[S'] = '@statement.outer' },
        },
      },
    },
